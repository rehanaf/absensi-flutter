...
class ApiService {
  ...
  Future<Map<String, dynamic>> submitMyAttendanceActivity(
    Map<String, dynamic> data,
  ) async {
    try {
      final response = await _apiClient.dio.post(
  ...
  Future<Map<String, dynamic>> submitMyPermit(
    Map<String, dynamic> data, {
  ...
  Future<Map<String, dynamic>> registerFace(String faceBiometric) async {
    try {
      final response = await _apiClient.dio.post(
        '/user/register-face',
        data: {'face_biometric': faceBiometric},
      );
      return response.data;
    } catch (e) {
      throw _handleException(e);
    ...
    try {
      ...
      for (var entry in settings.entries) {
        if (entry.value is MultipartFile) {
          ...
          formData.fields.add(
            MapEntry('settings[${entry.key}]', entry.value.toString()),
          );
        }
      }
  ...
  Future<Map<String, dynamic>> getAdminParentChildRequests({
    int page = 1,
    String? status,
  }) async {
    try {
      final response = await _apiClient.dio.get(
        '/admin/parent-child-requests',
        queryParameters: {
          'page': page,
  ...
  Future<Map<String, dynamic>> approveParentChildRequest(int id) async {
    try {
      final response = await _apiClient.dio.put(
        '/admin/parent-child-requests/$id/approve',
      );
      return response.data;
    } catch (e) {
      throw _handleException(e);
  ...
  Future<Map<String, dynamic>> rejectParentChildRequest(int id) async {
    try {
      final response = await _apiClient.dio.put(
        '/admin/parent-child-requests/$id/reject',
      );
      return response.data;
    } catch (e) {
      throw _handleException(e);
  ...
  Future<Map<String, dynamic>> attachUserToGroup(
    int groupId,
    int userId,
  ) async {
    try {
      final response = await _apiClient.dio.post(
        '/admin/groups/$groupId/attach-user',
        data: {'user_id': userId},
      );
      return response.data;
    } catch (e) {
  ...
  Future<Map<String, dynamic>> detachUserFromGroup(
    int groupId,
    int userId,
  ) async {
    try {
      final response = await _apiClient.dio.post(
        '/admin/groups/$groupId/detach-user',
        data: {'user_id': userId},
      );
      return response.data;
    } catch (e) {
  ...
  Future<Map<String, dynamic>> createFormField(
    Map<String, dynamic> data,
  ) async {
    try {
      final response = await _apiClient.dio.post(
  ...
  Future<Map<String, dynamic>> updateFormField(
    int id,
    Map<String, dynamic> data,
  ) async {
    try {
  ...
  Future<void> deleteLocation(int id) async {
    try {
      await _apiClient.dio.delete('/admin/locations/$id');
    } catch (e) {
      throw _handleException(e);
    }
  }
  ...
  Future<Map<String, dynamic>> createRole(Map<String, dynamic> data) async {
    try {
      final response = await _apiClient.dio.post('/admin/roles', data: data);
      return response.data;
    } catch (e) {
      throw _handleException(e);
    }
  ...
  Future<Map<String, dynamic>> updateRole(
    ...
    try {
      final response = await _apiClient.dio.put('/admin/roles/$id', data: data);
      return response.data;
    } catch (e) {
      throw _handleException(e);
    }
  ...
  Future<void> deleteRole(int id) async {
    try {
      await _apiClient.dio.delete('/admin/roles/$id');
    } catch (e) {
      throw _handleException(e);
    }
  }
  ...
  // --- Admin: Permits ---
  Future<Map<String, dynamic>> getPermits({
    int page = 1,
    String? search,
  }) async {
    try {
  ...
  Future<Map<String, dynamic>> createPermit(Map<String, dynamic> data) async {
    try {
      final response = await _apiClient.dio.post('/admin/permits', data: data);
      return response.data;
    } catch (e) {
      throw _handleException(e);
    }
  ...
  Future<void> deletePermit(int id) async {
    try {
      await _apiClient.dio.delete('/admin/permits/$id');
    } catch (e) {
      throw _handleException(e);
    }
  }
  ...
  Future<Map<String, dynamic>> createHoliday(Map<String, dynamic> data) async {
    try {
      final response = await _apiClient.dio.post('/admin/holidays', data: data);
      return response.data;
    } catch (e) {
      throw _handleException(e);
    }
  ...
  Future<Map<String, dynamic>> createShift(Map<String, dynamic> data) async {
    try {
      final response = await _apiClient.dio.post('/admin/shifts', data: data);
      return response.data;
    } catch (e) {
      throw _handleException(e);
    }
  ...
  Future<void> deleteShift(int id) async {
    try {
      await _apiClient.dio.delete('/admin/shifts/$id');
    } catch (e) {
      throw _handleException(e);
    }
  }
  ...
  // --- Admin: Rosters ---
  Future<Map<String, dynamic>> getRosters({
    int page = 1,
    String? search,
  }) async {
    try {
  ...
  Future<Map<String, dynamic>> createRoster(Map<String, dynamic> data) async {
    try {
      final response = await _apiClient.dio.post('/admin/rosters', data: data);
      return response.data;
    } catch (e) {
      throw _handleException(e);
    }
  ...
  Future<void> deleteRoster(int id) async {
    try {
      await _apiClient.dio.delete('/admin/rosters/$id');
    } catch (e) {
      throw _handleException(e);
    }
  }
  ...
  Future<void> deleteAnnouncement(int id) async {
    try {
      await _apiClient.dio.delete('/admin/announcements/$id');
    } catch (e) {
      throw _handleException(e);
    }
  }
