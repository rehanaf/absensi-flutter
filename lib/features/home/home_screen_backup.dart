                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Statistik (${_dashboardData?['month'] ?? '-'})',
                            style: Theme.of(context).textTheme.titleMedium
                                ?.copyWith(fontWeight: FontWeight.bold),
                          ),
                          const SizedBox(height: 16),
                          ...
                          if (_dashboardData != null &&
                              _dashboardData!['recent_history'] != null)
                            ...List.generate(
                              (_dashboardData!['recent_history'] as List)
                                  .length,
                              (index) {
                                final history =
                                    _dashboardData!['recent_history'][index];
                                final rawDate =
                                ...
                                if (status == 'sakit' || status == 'izin') {
                                  badgeBg = Colors.orange.withValues(
                                    alpha: 0.1,
                                  );
