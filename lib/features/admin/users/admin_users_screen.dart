...
class _AdminUsersScreenState extends State<AdminUsersScreen> {
  ...
  Future<void> _deleteUser(int id) async {
    final bool? confirm = await showDialog(
      context: context,
      builder: (context) => AlertDialog(title: const Text('Hapus Pengguna'), content: const Text('Apakah Anda yakin ingin menghapus pengguna ini? Tindakan ini tidak dapat dibatalkan.'), actions: [
      ...
      body: Column(
        children: [
          Padding(
            ...
            child: TextField(decoration: InputDecoration(border: const OutlineInputBorder(), hintText: 'Cari pengguna...'), onChanged: _onSearchChanged),
          ),
          Expanded(
            child: _isLoading
                                        ...
                                        children: [
                                          ListTile(
                                            ...
                                            leading: CircleAvatar(
                                              ...
                                              child: Text(initial, style: TextStyle(color: Theme.of(context).colorScheme.primary, fontWeight: FontWeight.bold)),
                                            ),
